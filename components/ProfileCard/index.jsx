import myself from '../../src/imgs/myself.png'
import discord from '../../src/imgs/discord-mark-white.svg'
...
const ProfileCard = () =>{
    ...
    return(
        <div salvo="bg-[#2c2c2c]" className="w-[100%] h-[100vh] bg-[url('https://uploads.spiritfanfiction.com/historias/capas/201811/green-14951564-231120181440.gif')] bg-cover bg-opacity-50 flex flex-col items-center">
            ...
            <span className='text-white font-semibold text-2xl mt-2'>{t("(Ele / Dele)")}</span>
            ...
            <div className='flex flex-row w-[80%] justify-evenly mt-6'>
                ...
                <a href="https://discordapp.com/users/239020378565902337" target='_blank'>
                    <img className={defaultStyle.icos} src={discord.src} alt="" />
                </a>
                <a href="https://github.com/KeplerFall" target='_blank'>
